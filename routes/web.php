...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::view('luxury-listing-incentives', 'pages.luxe_listing_incentives')->name('luxe-listing-incentives');
...
Route::group(
    ...
    function () {
        ...
        Route::get('/favorite-videos', [VideoFolderController::class, 'favoriteVideos'])->name('favorite.videos');
        ...
        Route::post('/videos/{video}/favorite', [VideoFolderController::class, 'toggleFavorite'])->name('video.toggle.favorite');
