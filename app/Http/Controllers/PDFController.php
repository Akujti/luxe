...
class PDFController extends Controller
{
    ...
    public function door_hanger_template_3(Request $request)
    {
        $data = [
            "text_1" => $request['text_1'],
            "text_2" => $request['text_2'],
    ...
    public function flyer_template_2(Request $request)
    {
        $data = [
            ...
            'text_6_select' => $request['text_6_select'],
    ...
    public function email_template_4(Request $request)
    {
        $data = [
            'text_1' => $request['text_1'],
            'text_2' => $request['text_2'],
        ...
        if ($_POST['action'] == 'Save') {
            ...
            $pdf = PDF::loadView('emails.template4.pdf', $data);
            return $pdf->download('Email Blast Template 4.pdf');
        }
    }
