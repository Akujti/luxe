!(function(e, t) {
    ...
    function n(i, r) {
        ...
        return c(function() {
            if (
                (null != f.deprecationHandler && f.deprecationHandler(null, i),
                a)
            ) {
        ...
        return e.isValid()
            ? ((t = H(t, e.localeData())),
              (R[t] =
                  ...
                  (function(s) {
                      for (
                          var e, i = s.match(N), t = 0, r = i.length;
                          t < r;
                          t++
                      )
                          W[i[t]]
    ...
    function Gt(e, t) {
        ...
        return t._isUTC
            ? ((n = t.clone()),
              (s =
                  (M(e) || a(e) ? e.valueOf() : Tt(e).valueOf()) - n.valueOf()),
                ...
                for (
                    var n = (function(e) {
                            var t,
                                n = [];
                            for (t in e)
                                m(e, t) && n.push({ unit: t, priority: E[t] });
                            return (
                                n.sort(function(e, t) {
