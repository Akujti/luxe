...
@section('js')
    <script>
        function calculate() {
            ...
            owners_title_policy.html("$" + (isNaN(owners_title_policy_result) ? '0.00' : parseInt(
            ...
            var estimated_total_result = parseInt(tax_proration_result + g14 + g15 + g16 + owners_title_policy_result +
