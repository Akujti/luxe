        ...
        <div class="row" style="padding: 10px;">
            ...
            <div class="row-input" style="max-width: 350px;">
                ...
                <div class="pr-10" style="margin-bottom:10px">
                    ...
                    <input type="file" id="img-1-input" onchange="image_change(this, 'img-1-input',['img_1'],'img_1_input')" style="display: none;">
                ...
                <div class="pr-10" style="margin-bottom:10px">
                    ...
                    <input type="file" id="img-3-input" onchange="image_change(this, 'img-3-input',['img_3'],'img_3_input')" style="display: none;">
                    <button type="button" class="mt-1" onclick="startCropper(1)">Crop</button>
                ...
                <div class="pr-10" style="margin-bottom:10px">
                    ...
                    <input type="file" id="img-4-input" onchange="image_change(this, 'img-4-input',['img_4'],'img_4_input')" style="display: none;">
                    <button type="button" class="mt-1" onclick="startCropper(1)">Crop</button>
                ...
                <div class="pr-10" style="margin-bottom:10px">
                    ...
                    <input type="file" id="img-5-input" onchange="image_change(this, 'img-5-input',['img_5'],'img_5_input')" style="display: none;">
                    <button type="button" class="mt-1" onclick="startCropper(1)">Crop</button>
...
<script>
    ...
    async function beforePDF() {
        ...
        const result = await generatePDF(264, 932)
        if(result) {
            $('.page').css('zoom', '.7')
