...
@section('content')
    ...
    <div class="container">
        <div class="row my-5">
            ...
            <div class="col-md-3 staff-box">
                <img src="{{ asset('images/staff/daniel.jpg') }}" class="staff-image">
                <p class="staff-name">Daniel Barrios</p>
                <p class="staff-role">Mortgage Loan Officer</p>
                <p class="staff-email"><a href="tel:3056107500">305.610.7500</a></p>
                <p class="staff-email"><a href="mailto:daniel@luxehomeloan.com">daniel@luxehomeloan.com</a></p>

                <a target="_blank" href="https://2086660.my1003app.com/2616358/register"
                    class="btn-luxe d-block text-center mt-2">APPLY NOW</a>
            </div>
            <div class="col-md-3 staff-box">
