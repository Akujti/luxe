            ...
            <div class="row-image">
                ...
                <div class="page" id="el">
                    ...
                    <div class="absolute" style="top:760px;left:0;">
                        <img id="img_3" src="images/flyers/template2/house1.jpg" alt="" style="width:215px;height:220px">
                    </div>
                    <div class="absolute" style="top:995px;left:0;">
                        <img id="img_4" src="images/flyers/template2/house2.jpg" alt="" style="width:215px;height:220px">
                    </div>
                    ...
                    <div class="absolute" style="bottom:0;right:0;">
                        <img id="img_5" src="images/flyers/template1/person.png" alt="" style="height:288px;width:209px;">
                    </div>
                    ...
                    <div class="absolute" style="top:500px;right:350px;text-align:right;">
                        ...
                        <p class="oswald-med white text-11" style="font-size: 75px;margin-top:-25px;letter-spacing:-3px">
                            $5,865,989
                        </p>
                    </div>
