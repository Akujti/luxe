        ...
        <div class="row theme">
            <div class="row theme">
                <div class="box-col-image">
                    <div class="preview-image" id="preview-image-box" style="background:url('/images/themes/assets/co-branded-templates/theme-1/tbt.jpg');">
                        ...
                        <div class="frame-box" id="frame-box">
                            ...
                            <img src="/images/themes/assets/co-branded-templates/theme-1/tbt.png" id="frame-image" alt="">
                        </div>
                    </div>
                    <div class="preview d-none">
                        <img src="/images/themes/assets/co-branded-templates/theme-1/tbt.jpg" id="person-image">
...
@section('js')
    <script>
        ...
        var oldBlob = '/images/themes/assets/co-branded-templates/theme-1/tbt.jpg';
