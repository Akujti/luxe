            ...
            <div class="row theme">
                <div class="box-col-image">
                    <div class="preview-image" id="preview-image-box"
                        style="background:url('/images/themes/assets/quotes/theme-1/tbt.jpg');">
                        ...
                        <div class="row theme">
                            <div class="w-100 form-group">
                                ...
                                <div class="form-input">
                                    <input type="text" id="black-box-1" value="A man"
                                        onkeyup="valueChanged(this, 'black-box-1-text')">
                                    <select name="" id="black-box-1-select"
                                        onchange="changeFont('black-box-1-text', 'black-box-1-select')">
                            ...
                            <div class="w-100 form-group">
                                ...
                                <div class="form-input">
                                    <textarea id="white-box-1"
                                        onkeyup="valueChanged(this, 'white-box-1-text')">travels the world<br> over in search<br> of what he needs and</textarea>
                                    <select name="" id="white-box-1-select"
                                        onchange="changeFont('white-box-1-text', 'white-box-1-select')">
                                        <option value="s" selected>Small</option>
                                        <option value="m">Medium</option>
                                        <option value="l">Large</option>
                                        <option value="xl">Extra Large</option>
                    ...
                    <div class="box-tools">
                        <div class="row theme">
                            <div class="w-100 form-group mt-0">
                                ...
                                <div class="form-input">
                                    <input type="text" id="black-box-2" value="returns home"
                                        onkeyup="valueChanged(this, 'black-box-2-text')">
                                    <select name="" id="black-box-2-select"
                                        onchange="changeFont('black-box-2-text', 'black-box-2-select')">
                                        <option value="s" selected>Small</option>
                                        <option value="m">Medium</option>
                                        <option value="l">Large</option>
                                        <option value="xl">Extra Large</option>
                            ...
                            <div class="w-100 form-group">
                                ...
                                <div class="form-input">
                                    <input type="text" id="white-box-2" value="to find it"
                                        onkeyup="valueChanged(this, 'white-box-2-text')">
                                    <select name="" id="white-box-2-select"
                                        onchange="changeFont('white-box-2-text', 'white-box-2-select')">
                                        <option value="s" selected>Small</option>
                                        <option value="m">Medium</option>
                                        <option value="l">Large</option>
                                        <option value="xl">Extra Large</option>
                            ...
                            <div class="w-100 form-group">
                                ...
                                <div class="form-input">
                                    <input type="text" id="name" value="George A.<br> Moore"
                                        onkeyup="valueChanged(this, 'name-text')">
                            ...
                            <div class="w-100 form-group">
                                ...
                                <div class="form-input">
                                    <input type="text" id="author" value="author"
                                        onkeyup="valueChanged(this, 'author-text')">
                                </div>
                            </div>
