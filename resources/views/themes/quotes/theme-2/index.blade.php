            ...
            <div class="row theme">
                <div class="box-col-image">
                    <div class="preview-image" id="preview-image-box"
                        style="background:url('/images/themes/assets/quotes/theme-2/tbt.jpg');">
                        ...
                        <div class="row theme">
                            <div class="w-100 form-group">
                                ...
                                <div class="form-input">
                                    <input type="text" id="content-1" value="THERE is"
                                        onkeyup="valueChanged(this, 'content-1-text')">
                                </div>
                            </div>
                            <div class="w-100 form-group">
                                <div class="form-label">
                                ...
                                <div class="form-input">
                                    <input type="text" id="content-2" value="LITTLE<br>SUCCESS"
                                        onkeyup="valueChanged(this, 'content-2-text')">
                                </div>
                            </div>
                    ...
                    <div class="box-tools">
                        <div class="row theme">
                            <div class="w-100 form-group mt-0">
                                ...
                                <div class="form-input">
                                    <input type="text" id="content-3" value="WHERE THERE IS"
                                        onkeyup="valueChanged(this, 'content-3-text')">
                                </div>
                            </div>
                            <div class="w-100 form-group">
                                <div class="form-label">
                                ...
                                <div class="form-input">
                                    <input type="text" id="content-4" value="LITTLE"
                                        onkeyup="valueChanged(this, 'content-4-text')">
                                </div>
                            </div>
                            <div class="w-100 form-group">
                                <div class="form-label">
                                ...
                                <div class="form-input">
                                    <input type="text" id="content-5" value="LAUGHTER"
                                        onkeyup="valueChanged(this, 'content-5-text')">
                                </div>
                            </div>
                            <div class="w-100 form-group">
                                <div class="form-label">
                                ...
                                <div class="form-input">
                                    <input type="text" id="name" value="- Andreq Carnegie"
                                        onkeyup="valueChanged(this, 'content-name-text')">
                                </div>
                            </div>
