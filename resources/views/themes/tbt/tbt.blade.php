...
<body>
    <div class="page">
        <div class="absolute" style="left:11.7%;top:403px;">
            <h1 class="font-800 " style="font-size:134px;">{{$page_1_text_1}}</h1>
            <h1 class="font-800 gold" style="font-size:134px;line-height: 60px;">{{$page_1_text_2}}</h1>
        </div>
        <div class="absolute"
        ...
        <div>
            <img class="absolute" style="top:19.2%;left:11.4%;object-fit:cover;" src="{{ $img_1_input }}" alt=""
