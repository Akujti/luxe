                    ...
                    <div class="preview-image" id="preview-image-box">
                        <div class="frame-box" id="frame-box">
                            <div class="box-items">
                                ...
                                <p class="frame-phone"><img src="/images/index-page/phone-icon-white.svg" alt="">
                                    <span>(XXX) XXX-XXXX</span>
                                </p>
                                <p class="frame-email"><img src="/images/index-page/email-white-icon.svg" alt="">
                                    <span>email@luxeknows.com</span>
                                </p>
                            </div>
                            <img src="/images/themes/assets/agents/theme-2/tbt.png" id="frame-image" alt="">
                        </div>
                        <div id="person-image-div"
                            style="background: url('/images/themes/assets/agents/theme-2/person.jpg')"></div>
                    </div>
