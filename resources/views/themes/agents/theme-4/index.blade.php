                    ...
                    <div class="preview-image" id="preview-image-box" style="background-color: #000;">
                        <div class="frame-box" id="frame-box">
                            <div class="inner-image"
                                style="background:url('/images/themes/assets/agents/theme-4/person.jpg');">
                            </div>
                            <div class="box-items">
                                <p class="frame-title"></p>
                            </div>
                            <img src="/images/themes/assets/agents/theme-4/tbt.png" id="frame-image" alt="">
                        </div>
                    </div>
                    <div class="preview d-none">
                        <img src="/images/themes/assets/agents/theme-4/person.jpg" id="person-image">
                    </div>
                </div>
                        ...
                        <div class="row theme">
                            <div class="w-100 form-group">
                                ...
                                <div class="form-input">
                                    <input type="text" name="name" id="name" value="ELISSA M. URQUIAGA"
...
@section('js')
    <script>
        ...
        var oldBlob = '/images/themes/assets/agents/theme-4/person.jpg';
