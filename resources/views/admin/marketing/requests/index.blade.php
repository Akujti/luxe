            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $canva->id }}</td>
                        <td>{{ $canva->title }}</td>
                        <td><img src="{{ asset('storage/'.$canva->image) }}" id="img" width="75px" height="75px"></td>
                        ...
                        <td>
                            ...
                            <button class="btn btn-primary px-3 py-2" onclick="window.location = '{{ route("
                                admin.canva.categories.index", $canva->id) }}'">View</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
