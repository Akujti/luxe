    ...
    <div class="container-fluid">
        <div class="m-0">
            <div class="w-100 d-flex justify-content-between align-items-center mb-3">
                <h5 class="h5-luxe">{{$property->address}} - Images</h5>
            </div>
            <div class="mb-3">
                <form method="POST" enctype="multipart/form-data"
                      action="{{ route('admin.photographers.properties.images.store',[$property->photographer_id,$property->id]) }}">
                    @csrf
                    ...
                    @foreach ($property->images as $image)
                        <tr id="tr-row">
                            ...
                            <td id="td-row">
                                <div>
                                    <form
                                        action="{{route('admin.photographers.properties.images.destroy',[$property->photographer_id,$property->id,$image->id])}}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
