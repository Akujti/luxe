<div class="update-photographer modal fade modal-new" tabindex="-1" role="dialog">
                    ...
                    <div class="row m-0 p-0">
                        <div class="form-group">
                            ...
                            <div class='input-group'>
                                <input id="name" type="text" class="w-100 form-control" name="name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="start">Email</label>
                            <div class='input-group'>
                                <input id="email" type="email" class="w-100 form-control" name="email" required>
                            </div>
                        </div>
