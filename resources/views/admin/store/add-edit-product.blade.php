                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-5">
                                    ...
                                    <button class="btn btn-luxe btn-rounded" type="button"
                                        onclick="add_new_variant()">+</button>
                                </div>
                                            ...
                                            @foreach ($product->variants[0]->values as $key => $row)
                                                <div
                                                    ...
                                                    <button class="btn btn-danger btn-rounded" type="button"
                                                        onclick="remove_variant(this)">-</button>
                                                </div>
                                            @endforeach
                                        @endif
                                    @endif
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="image-box-image">
                                                            <img src="{{ asset('storage/' . $row->image) }}"
                                                                height="70px" alt="">
                                                            <button class="btn btn-danger btn-rounded" type="button"
                                                                onclick="remove_image_ajax(this, {{ $row->id }})">&times;</button>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
