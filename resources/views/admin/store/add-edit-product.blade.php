...
<div class="container-fluid">
    <div class="row m-0">
        ...
        <div class="row m-0 w-100">
            <form action="{{ $product ? route('admin.luxe_store.products.update') : route('admin.luxe_store.products.create') }}" method="POST" enctype="multipart/form-data" class="row p-0 m-0 w-100">
                @if($product)
                @method('put')
                    ...
                    <div class="row p-0 m-0 d-flex col-12">
                        <div class="form-group col-12 col-md-6 col-lg-2">
                            ...
                            <div class="row m-0 p-0 mb-3">
                                <img src="{{ asset('storage/'. $product->preview_image) }}" id="preview-image" width="150px" height="150px" alt="" onclick="toggleImage()">
                                <input type="file" name="preview_image" id="preview-image-input" style="display:none" onchange="onFileChanged(this)">
                            </div>
                            @else
                        ...
                        <div class="form-group col-12 col-lg-2 col-md-4">
                            ...
                            <input type="text" name="stock" class="form-control" value="{{  $product ? $product->stock : '' }}" required>
                        </div>
                    </div>
                    <div class="row p-0 m-0 d-flex col-12">
                    ...
                    <div class="row m-0 d-flex col-12">
                        <div class="col-12 col-md-6">
                            ...
                            @else
                                @foreach($categories as $category)
                                    <div class="col-12 p-0 m-0 checkbox">
                                        <input type="checkbox" class="checkbox-input" name="categories[]" value="{{ $category->id }}" required onchange="category_checkbox()"> {{ $category->name }}
                                    </div>
                                @endforeach
                            @endif
                        </div>
                        <div class="col-12 col-md-6">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-5">
                                ...
                                <button class="btn btn-luxe btn-rounded" type="button" onclick="add_new_variant()">+</button>
                            </div>
                    ...
                    <div class="row m-0 d-flex col-12">
                        <div class="col-12 col-md-6">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <button class="btn btn-luxe btn-rounded" type="button" onclick="add_new_input()">+</button>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <button class="btn btn-luxe btn-rounded" type="button" onclick="add_new_image()">+</button>
                            </div>
                                    ...
                                    <div class="col-12 p-0 mt-2 image-box">
                                        <div class="row p-0 m-0 w-100">
                                            @foreach($product->images as $row)
                                                <div class="col-6 col-lg-2 col-md-4 p-0 d-flex justify-content-center image-box-col mb-4">
                                                    <div class="image-box-image">
                                                        <img src="{{ asset('storage/'. $row->image) }}" height="70px" alt="">
                                                        <button class="btn btn-danger btn-rounded" type="button" onclick="remove_image_ajax(this, {{ $row->id }})">&times;</button>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
