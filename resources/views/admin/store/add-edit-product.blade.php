                        ...
                        <div class="row p-0 m-0 d-flex col-12">
                            <div class="form-group col-12 col-xl-4">
                                ...
                                <textarea name="description" class="form-control"
                                          rows="6">{{ $product ? $product->description : '' }}</textarea>
                            </div>
                            <div class="form-group col-12 col-xl-4">
                                <label for="">Short Description</label>
                                <textarea name="description_2" class="form-control"
                                          rows="6">{{ $product ? $product->description_2 : '' }}</textarea>
                            </div>
                            <div class="form-group col-12 col-xl-4">
                                <label for="">Verbiage Text</label>
                                <textarea name="verbiages_text" class="form-control"
                                          rows="6">{{ $product ? $product->verbiages_text : '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row m-0 d-flex col-12">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-5">
                                    ...
                                    <button class="btn btn-luxe btn-rounded" type="button"
                                            onclick="add_new_variant()">+
                                    </button>
                                </div>
