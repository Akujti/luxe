                                ...
                                <ul class="navbar__dropdown d-flex justify-content-center align-items-center">
                                    <li class="nav-item dropdown">
                                        <a class="d-flex align-items-center nav-link dropdown-toggle m-0 p-0"
                                            href="#" id="navbarDropdownMenuLink" data-bs-toggle="dropdown"
                            ...
                            <nav class="row">
                                ...
                                <div class="dropdown">
                                    <a class="dropdown-toggle" type="button" id="dropdownMenuButton"
                                        ...
                                        aria-expanded="false" style="color:#a8a8a8 !important;cursor: pointer;">
                                        Store
                                    </a>
                                ...
                                <div class="dropdown" style="width:400px">
                                    <a class="dropdown-toggle" type="button" id="dropdown-other"
                                        data-bs-toggle="dropdown" role="button" aria-haspopup="true"
                                        aria-expanded="false" style="color:#a8a8a8 !important;cursor: pointer;">
                                        Other
                                    </a>
