                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger rounded"
                                        onclick="delete_event({{ $form }})">Delete</button>
                                    <button class="btn btn-luxe rounded" onclick="update({{ $form }})">Edit</button>
                                    <button class="btn btn-luxe rounded"
                                        onclick="update_event({{ $form }})">Emails</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.forms.update.form') }}" method="POST" class="d-block"
                        ...
                        <div class="form-group row p-0 m-0 mt-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control mr-2" name="verbiages_title"
                                    id="verbiages_title">
                            </div>
                        </div>
                        ...
                        <div class="form-group row p-0 m-0 mt-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control mr-2" name="after_submit_verbiages_title"
                                    id="after_submit_verbiages_title">
                            </div>
                        </div>
        ...
        function update_event(form) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                html += '<tr>' +
                    ...
                    (data[i].bcc ? "checked" : "") + ' name="bcc[' + data[i].email + ']">BCC</td>' +
                    '<td class="py-0 border-0"><button type="button" class="btn btn-danger btn-delete" onclick="remove_email(this)">&times;</button></td>' +
                    '<td class="py-0 border-0"><input type="hidden" name="emails[]" value="' + data[i].email + '"></td>' +
                    '</tr>';
            }
            html += '</table>';
