...
<div class="page">
    ...
    <div class="absolute" style="bottom: 2170px;left:150px;width:450px">
        ...
        <p class="bold" style="font-size: 30px;margin-top:30px;letter-spacing: -1px">{!! $text_location !!}</p>
    </div>
    ...
    <div class="absolute" style="left:835px;top:110px">
        ...
        <table style="width:1125px;margin-bottom:30px">
            @for ($i = 0; $i < count($section_1_title); $i++)
                <tr>
                    <td>
        ...
        <table style="min-width:750px;margin-bottom:30px">
            @for ($i = 0; $i < count($section_2_title); $i++)
                <tr>
                    <td>
        ...
        <table style="min-width:750px;margin-bottom:30px">
            @for ($i = 0; $i < count($section_3_title); $i++)
                <tr>
                    <td>
        ...
        <table style="min-width:750px">
            @for ($i = 0; $i < count($section_4_title); $i++)
                <tr>
                    <td>
    ...
    <div class="absolute" style="left:835px;top:1150px">
        ...
        <div>
            <table class="listings" style="min-width: 1010px">
                ...
                @endphp
                @for ($index = 0; $index < count($text_references)/5; $index++)
                    <tr>
                        @for ($index_2 = $index*5; $index_2 < $index*5+5; $index_2++)
                            <td>
    ...
    <div class="absolute" style="left:835px;top:2260px">
        ...
        <div>
            <table class="listings" style="min-width: 1010px">
                ...
                @endphp
                @for ($index = 0; $index < count($current_listings)/5; $index++)
                    <tr>
                        @for ($index_2 = $index*5; $index_2 < $index*5+5; $index_2++)
                            <td>
