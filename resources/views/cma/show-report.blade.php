...
@section('content')
    ...
    <section class="section-header section-comparables section-top-comparables"
             style="height:auto;min-height:100vh;max-height:300vh;">
        <section class="section-img" style="position:relative;transform:unset !important;top:unset;left:unset;">
            ...
            <div>
                <div class="row p-0 m-0" id="top-comparables">
                    <h1 class="text-center" style="color:black;font-size:20px;text-align:center;width:100%;">
                        Loading...</h1>
                </div>
            </div>
        </section>
    ...
    <section class="section-header section-comparables section-top-comparables"
             style="height:auto;min-height:79vh;max-height:300vh;">
        <section class="section-img">
        ...
        function fillCharts () {
            ...
            Highcharts.chart('chart1', {
                ...
                series: [{
                    name: 'Value',
                    colorByPoint: true,
                    data: Object.values(listingsIdsData).map(el => {
                        return {
                            name: el.BuyerAgentFullName,
                            y: el.ListPrice
                        }
                    })
                }]
