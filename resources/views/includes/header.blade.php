                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="43.062" height="43.062"
                                ...
                                <g id="vuesax_bold_location" data-name="vuesax/bold/location"
                                    ...
                                    <path id="Vector-3" data-name="Vector" d="M0,0H43.062V43.062H0Z"
                                        transform="translate(471.062 231.062) rotate(180)" fill="none" opacity="0">
                                    </path>
                                </g>
                            </svg>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="43.062" height="43.062"
                                ...
                                <g id="vuesax_bold_global" data-name="vuesax/bold/global"
                                    ...
                                    <path id="Vector-11" data-name="Vector" d="M0,0H43.062V43.062H0Z"
                                        transform="translate(215.062 295.062) rotate(180)" fill="none" opacity="0">
                                    </path>
                                </g>
                            </svg>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="43.062" height="43.062"
                                ...
                                <g id="vuesax_bold_call" data-name="vuesax/bold/call" transform="translate(-108 -188)">
                                    <g id="call" transform="translate(108 188)">
                                        ...
                                        <path id="Vector-3" data-name="Vector" d="M0,0H43.062V43.062H0Z"
                                            transform="translate(43.062 43.062) rotate(180)" fill="none" opacity="0">
                                        </path>
                                    </g>
                                </g>
                            </svg>
                            <span>(305) 438 7764</span></a>
                    </div>
                </div>
            </div>
