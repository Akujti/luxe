...
<script>
    ...
    function change_view() {
        ...
        window.location.href = '{{ url('user/file-posts') }}?view=' + value + '<?php if (isset($_GET['sort'])) {
            echo '&sort=' . $_GET['sort'];
        } ?>'
    }
    ...
    function change_sort() {
        ...
        window.location.href = '{{ url('user/file-posts') }}?sort=' + value + '<?php if (isset($_GET['view'])) {
            echo '&view=' . $_GET['view'];
        } ?>'
    }
