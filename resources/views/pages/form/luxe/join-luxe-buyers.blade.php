            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('general.email.post') }}" class="card form mb-5 p-3" method="POST"
                    ...
                    <div class="card-header">
                        <h1 class="text-center my-4">Join LUXE Buyers</h1>
                    </div>

                    <input type="hidden" name="form_title" value="Join LUXE Buyers">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            {{--                            </div>--}}
                            <div class="form-group col-md-6">
                                <label for="name">Do you agree to use the LUXE Buyer Team's preferred lender and title
                                    company?</label>
                                <select
                                    name="do_you_agree_to_use_the_LUXE_buyer_teams_preferred_lender_and_title_company"
                                    class="form-control" required>
                                    <option value>-</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
