...
@section('content')
    <div class="{{ auth()->check() ? 'container-fluid' : 'container mt-4' }}">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form action="{{ route('general.email.post') }}" class="card form mb-5 p-3" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header">
                        <h1 class="text-center my-4">Get Contract Help</h1>
                        <h6 id="agent-text" class="text-center" style="font-size: 21px;">Contract Specialist Will Reach Out Within 1 Business Day</h6>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" name="upload_document_you_would_like_reviewed" class="form-control p-1" required>
                            </div>
