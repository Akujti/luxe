            ...
            <div class="col-md-12">
                <form action="{{ route('general.email.post') }}" class="card form mb-5 p-3" method="POST"
                    ...
                    <div class="card-header">
                        ...
                        <h6 id="agent-text" class="text-center" style="font-size: 17px;">
                            It is against MLS rules to cancel and relist a property. While agents are sometimes doing
                            this and not getting caught by submitting this form you agree to be 100% responsible for any
                            fines incurred by the brokerage. MLS fine is $5,000 per instance.
                            <br><br>Please note it is company policy to withdraw listings. Although you may have a
                            signed
                            cancellation, all cancellations must be approved by broker.
                        </h6>
                    </div>
