            ...
            <div class="col-md-12">
                <form action="{{ route('general.email.post') }}" class="card form mb-5 p-3" method="POST"
                    ...
                    <div class="card-header">
                        ...
                        <h6 id="agent-text" class="text-center" style="font-size: 21px;">It is against MLS rules to
                            cancel and relist a property. While agents are sometimes doing this and not getting caught
                            by submitting this form you agree to be 100% responsible for any fines incurred by the
                            brokerage. MLS fine is $5,000 per instance.</h6>
                    </div>
