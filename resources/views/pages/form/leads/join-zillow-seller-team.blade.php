                    ...
                    <div class="card-body row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <p>The above compensation structure applies to gross commissions for real estate brokerage
                                ...
                                transaction fees). The compensation structure applies for any and all leads and
                                referrals
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>• Agent agrees to refer Law Offices of Adorno-Cunill & Damas and Capital Title Group
                                    as
                                    title companies for seller title work.
                                </li>
                                <li>• Agent agrees to charge a $295 processing fee to seller and buyer.</li>
                                <li>• As per Zillow rules, all listings shall be closed out on the MLS under Team Leader
                                    as
                                    first agent. Agent will be second agent on MLS.
                                </li>
                                <li>• Agent agrees to maintain a Tech and Lead Subscription, which includes
                                    FollowUpBoss, in
                                    order to be an active agent with Broker. FollowUpBoss must be used and updated as
                                    per
                                    Zillow rules. In the event that Agent is delinquent in the payment of the
                                    subscription,
                                    all access to the leads will be terminated.
                                </li>
                                <li>• If agent needs assistance on listing presentation, it will be referred to Team
                                    Leader.
                                </li>
                                <li>• Agent agrees that any leads not contacted in 30 minutes shall be reassigned to a
                                    Team
                                    Leader.
                                </li>
                                <li>• Agent agrees the leads shall be worked by an ISA.</li>
                                <li>• Agent shall execute said Referral/Exit Agreement within 24 hours of terminating
                                    its
                                    relations with the team.
                                </li>
                                <li>• Agent agrees that all leads assigned will always be considered property of Broker
                                    and
                                    the commission split fee is due in the event the agent severs its relations with
                                    Broker.
                                </li>
