            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('general.email.post') }}" class="card form p-3 mb-3" method="POST"
                    ...
                    <div class="card-header">
                        <h1 class="text-center my-4">Submit A Zillow Buyer Brokerage Agreement</h1>
                    </div>
                    <input type="hidden" name="form_title" value="Submit A Zillow Buyer Brokerage Agreement">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="name">Upload Fully Executed Buyer Brokerage Agreement </label>
                                <input type="file" name="agreement" class="form-control p-1" required>
                            </div>
