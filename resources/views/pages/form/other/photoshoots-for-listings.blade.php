...
@section('content')
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content bg-white">
                            ...
                            <div class="modal-body py-0 text-center">
                                @php
                                    $product = \App\Models\LuxeStore\LuxeStoreProduct::whereSlug(
                                        'zillow-listing-showcase-shoot',
                                    )->first();
                                @endphp
                                ...
                                <button class="btn btn-luxe mb-3" onclick="addToCart()">Add To Cart
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function toggleModal() {
            if (proxy.value && !$('#option-9').is(':checked'))
                $('#modal').modal('show')
        }
        ...
        paypal.Buttons({
            ...
            onInit: function(data, actions) {
                ...
                const checkValidity = () => {
                    if (document.getElementById('photo-form').checkValidity() && !proxy.value) {
                        actions.enable();
                    } else {
                        actions.disable();
                    }
