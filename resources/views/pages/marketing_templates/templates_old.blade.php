...
<div class="container">
    <div class="row justify-content-center">
        <h3 class="text-center font-weight-normal">Please choose a theme below which you want to use. Just click on it and then you can edit.</h3>
        @auth()
    ...
    <div class="row my-4">
        @if($templates->count())
            ...
            <div class="col-md-3">
                <a href="{{route('canva.marketing.template',['marketingCategory'=>$template->category, 'template'=>$template])}}">
