            ...
            <div class="col-12 col-md-12 col-lg-7 coaching-text">
                <div>
                    @if($enrollment_type == '$149 per month (minimum 6-month commitment)')
                        <div>Option #1 - <span class="gothicbold">$149 per month</span> (minimum 6-month commitment)</div>
                    @else
                        <div>Option #2 - <span class="gothicbold">Additional 10% fee on your next 6 transactions</span> (12 months of coaching from the date of this agreement)</div>
                    @endif
                </div>
                ...
                <div class="inputs" style="margin-top:20px;margin-left:5px;">
                    ...
                    <div class="input-group mb-3" style="margin-bottom: 20px">
                        ...
                        <input type="text" name="signature" class="form-control signature" value="{{ $full_name }}">
                    </div>
                    <div class="input-group mb-3" style="margin-bottom: 20px">
                ...
                <div style="margin-bottom:30px;">
                    <p style="border-bottom:2px solid black;padding-bottom:5px; font-style:italic;font-size:20px">Please complete the credit card authorization below if you selected Option #1 above.</p>
                    ...
                    <div class="inputs mt-5">
                        <div style="margin-bottom: 20px">
                            ...
                            <input type="text" class="form-control" style="width: 500px" value="{{ $name_of_cardholder }}">
                        </div>
                        <div>
                            <span style="font-size:16px;">Address of Cardholder:</span>
                            <input type="text" class="form-control" style="width: 487px" value="{{ $address_of_cardholder }}">
                        </div>
                        <br>
                        <div>
                            <span style="font-size:16px;">Credit Card Number(s):</span>
                            <input type="text" class="form-control" style="width: 485px" value="{{ $credit_card_numbers }}">
                        </div>
                        <div style="font-size:15px;margin-bottom:15px;margin-top:15px;">Type of Credit Card:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="{{ ($type_of_credit_card == 'American Express') ? 'rounded' : '' }}">American Express</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="{{ ($type_of_credit_card == 'Visa') ? 'rounded' : '' }}">Visa</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="{{ ($type_of_credit_card == 'Mastercard') ? 'rounded' : '' }}">Mastercard</span></div>
                        <div>
