...
<div class="container-fluid">
    <div class="col-12 title mb-3">
        ...
        <div class="modal fade modal-new" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-show="true">
        ...
        <div class="col-12 col-md-12 col-lg-6">
            <form action="{{ route('coaching.form.submit') }}" method="POST" class="row p-0 m-0">
                ...
                <div class="row p-0 m-0 w-100 d-none" id="credit-card-inputs">
                    <div class="col-12">
                        <p style="font-size:17px">I authorize the company to regularly charge my card on the amount indicated in this form on a regular basis,
