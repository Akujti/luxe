                    ...
                    <div class="box-file col-md-12 mb-4">
                        <div class="folder" style="min-height: 84px !important;">
                            <div class="row p-0 m-0 w-100 d-flex align-items-center">
                                <a href="{{ route('files.download', $file) }}" target="_blank" class="row m-0 p-0 w-100">
...
<script>
    ...
    function change_view() {
        ...
        window.location.href = '{{ url('user/guides') }}?view=' + value + '<?php if (isset($_GET['sort'])) {
            echo '&sort=' . $_GET['sort'];
        } ?>'
    }
    ...
    function change_sort() {
        ...
        window.location.href = '{{ url('user/guides') }}?sort=' + value + '<?php if (isset($_GET['view'])) {
            echo '&view=' . $_GET['view'];
        } ?>'
    }
