        ...
        <div class="row p-0 m-0">
            <div class="col-12 col-md-12 col-lg-8">
                <form action="{{ route('luxe_store.order.create') }}" method="POST" class="row m-0 p-0" id="form">
                    ...
                    <div>
                        <input type="checkbox" name="same_as_billing" id="same_as_billing" checked="" onchange="address()">&nbsp;Shipping details same as billing details
                    </div>
                    <div class="mt-5"></div>
                    ...
                    <div class="row p-0 m-0" id="shipping_address">
                        ...
                        <div class="col-6 form-group">
                            <label for="">Agent name*</label>
                            <input type="text" name="shipping[agent_name]" class="form-control" value="0" required>
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Agent surname*</label>
                            <input type="text" name="shipping[agent_surname]" class="form-control" value="0" required>
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Company name*</label>
                            <input type="text" name="shipping[company_name]" class="form-control" value="0" required>
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Country*</label>
                            <select name="shipping[country]" id="billing_country" class="form-control" value="US" required>
                                <option value="">Select a country / region…</option>
                                <option value="AF">Afghanistan</option>
                                <option value="AX">Åland Islands</option>
                                <option value="AL">Albania</option>
                        ...
                        <div class="col-6 form-group">
                            <label for="">Street Address*</label>
                            <input type="text" name="shipping[street_address]" class="form-control" value="0" required>
                        </div>
                        <div class="col-6 form-group">
                            <label for="">City*</label>
                            <input type="text" name="shipping[city]" class="form-control" value="0" required>
                        </div>
                        <div class="col-6 form-group">
                            <label for="">State</label>
                            <input type="text" name="shipping[state]" class="form-control" value="0" required>
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Zip code*</label>
                            <input type="text" name="shipping[zip_code]" class="form-control" value="0" required>
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Phone*</label>
                            <input type="text" name="shipping[phone]" class="form-control" value="0" required>
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Email*</label>
                            <input type="text" name="shipping[email]" class="form-control" value="0" required>
                        </div>
                        <h5 class="pl-3">Additional information</h5>
                        <div class="col-12 form-group">
                            <label for="">Special Instructions for Seller (optional)</label>
