...
@section('content')
    <style>
        main {
            background-image: url("{{asset('images/header/bg.jpg')}}") !important;
    ...
    <div class="container custom-padding">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-center" style="background:#FFCF40;font-size:20px;"><img
                            class="login-logo"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input id="email" type="email"
                                           class="min-input card-input @error('email') is-invalid @enderror"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input id="password" type="password"
                                           class="min-input card-input @error('password') is-invalid @enderror"
                                           name="password"
                                           required
