...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row m-0">
            <div class="w-100 d-flex justify-content-between align-items-center mb-5">
                <h5 class="h5-luxe">Marketing Orders</h5>
            </div>
                    ...
                    <tbody>
                        @forelse($marketing_orders as $order)
                            <tr id="tr-row">
                                ...
                                <td id="td-row">{{ $order->status }}</td>
                                <td id="td-row"><a class="btn btn-link"
                                        href="{{ route('my.marketing.orders.show', $order->id) }}">View</a></td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="7">No marketing orders found</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
